...
- 闭合本地 research workflow：structured questions、findings、decisions、risks、本地 source extraction、reviewed/draft source packs 和 research handoff packets。
- Readiness 现在会对 upstream/parity work 的不完整 research evidence 给出 warning，不再把 source-pack capture 当作完整 research parity。
